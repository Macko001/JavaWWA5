...
public class TweetsServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //to do retrive tweets from database
        ...
        for (TwitterMessageDto twitterMessageDto: tweets){
            out.println("<li><div>id ="+twitterMessageDto.getId()+ "message "+twitterMessageDto.getMessage()+"username "+ twitterMessageDto.getUsername()+"</div></li>");
            out.println("</ul>");
            out.println("</body>");
            out.println("</html>");
